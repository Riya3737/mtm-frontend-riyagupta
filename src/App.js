...
function App() {
  ...
  useEffect(() => {
    axios.get('https://mtm-backend-riyagupta.vercel.app/tasks')
  ...
  const addTask = (task) => {
    console.log(task);
    axios.post('https://mtm-backend-riyagupta.vercel.app/tasks', task, {
      headers: {
  ...
  const updateTask = (updatedTask) => {
    axios.put(`https://mtm-backend-riyagupta.vercel.app/tasks/${updatedTask._id}`, updatedTask, {
      headers: {
        'Content-Type': 'application/json'
      }
    })
  ...
  const deleteTask = (taskId) => {
    axios.delete(`https://mtm-backend-riyagupta.vercel.app/tasks/${taskId}`)
      .then(() => {
